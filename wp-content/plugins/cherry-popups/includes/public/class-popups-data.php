...
//					$html .= sprintf( '<div class="cherry-popup-check cherry-popup-show-again-check"><div class="marker"><span class="dashicons dashicons-yes"></span></div><span class="label">%1$s</span></div>', pll__(esc_html__( 'Don\'t show again' , 'cherry-popups' ) ));
//                  Polylang translate string
                    $html .= '<div class="cherry-popup-check cherry-popup-show-again-check"><div class="marker"><span class="dashicons dashicons-yes"></span></div><span class="label">'.pll_esc_html__('Don\'t show again' ).'</span></div>';
