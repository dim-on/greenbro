...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php jardinier_ads_post_before_content() ?>

	<?php $utility = jardinier_utility()->utility; ?>
	...
	<div class="post__right-col">
		...
		<div class="entry-content">
			...
			<?php wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links__title">' . esc_html__( 'Pages:', 'jardinier' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span class="page-links__item">',
				'link_after'  => '</span>',
				'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'jardinier' ) . ' </span>%',
