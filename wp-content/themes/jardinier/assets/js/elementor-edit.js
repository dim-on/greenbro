( function( $, data ) {
	...
	var jardinierElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, jardinierElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, jardinierElementor.initCb );
		},
	...
	jardinierElementor.init();

}( jQuery, window.jardinierEditData ) );
