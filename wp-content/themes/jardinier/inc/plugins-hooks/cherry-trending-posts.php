...
add_filter( 'cherry_trend_posts_date_args', 'jardinier_cherry_trend_posts_date_args' );
add_filter( 'cherry_trend_posts_comments_args', 'jardinier_cherry_trend_posts_comments_args' );
add_filter( 'cherry_trend_posts_author_args', 'jardinier_cherry_trend_posts_author_args' );
add_filter( 'cherry_trend_posts_category_args', 'jardinier_cherry_trend_posts_category_args' );
add_filter( 'cherry_trend_posts_tag_args', 'jardinier_cherry_trend_posts_tag_args' );
add_filter( 'cherry_trend_posts_button_args', 'jardinier_cherry_trend_posts_button_args' );
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_date_args( $args = array() ) {
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_comments_args( $args = array() ) {
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_author_args( $args = array() ) {
	$args['prefix'] = esc_html__( 'by ', 'jardinier' );
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_category_args( $args = array() ) {
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_tag_args( $args = array() ) {
 ...
 * @return array
 */
function jardinier_cherry_trend_posts_button_args( $args = array() ) {
