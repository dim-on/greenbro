...
if ( ! class_exists( 'Jardinier_Elementor' ) ) {

	/**
	 * Define Jardinier_Elementor class
	 */
	class Jardinier_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = jardinier_theme()->get_core()->modules['cherry-js-core'];
			$ui      = jardinier_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = jardinier_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'jardinier-edit', 'jardinierEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'jardinier' ) ) {
					continue;
				}
...
/**
 * Returns instance of Jardinier_Elementor
 *
 * @return object
 */
function jardinier_elementor() {
	return Jardinier_Elementor::get_instance();
}
