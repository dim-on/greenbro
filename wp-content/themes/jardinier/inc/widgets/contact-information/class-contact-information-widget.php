...
if ( ! class_exists( 'Jardinier_Contact_Information_Widget' ) ) {

	/**
	 * Class Jardinier_Contact_Information_Widget.
	 */
	class Jardinier_Contact_Information_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an contact-information.', 'jardinier' );
			$this->widget_id          = 'jardinier_contact_information_widget';
			$this->widget_name        = esc_html__( 'Contact Information', 'jardinier' );
			...
			$this->settings           = array(
				...
				'contact_information' => array(
					'type'         => 'repeater',
					'add_label'    => esc_html__( 'Add Contact Information', 'jardinier' ),
					'title_field'  => 'value',
					'hidden_input' => true,
					'fields'       => array(
						'icon'  => array(
							...
							'id'        => 'icon',
							'name'      => 'icon',
							'label'     => esc_html__( 'Choose icon', 'jardinier' ),
							'width'     => 'full',
						...
						'value' => array(
							...
							'id'          => 'value',
							'name'        => 'value',
							'placeholder' => esc_html__( 'Value', 'jardinier' ),
							'label'       => esc_html__( 'Value', 'jardinier' ),
						),
					),
				),
			);
...
add_action( 'widgets_init', 'jardinier_register_contact_information_widget' );
/**
 * Register contact information widget.
 */
function jardinier_register_contact_information_widget() {
	register_widget( 'Jardinier_Contact_Information_Widget' );
}
