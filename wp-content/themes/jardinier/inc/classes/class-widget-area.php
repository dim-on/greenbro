...
if ( ! class_exists( 'Jardinier_Widget_Area' ) ) {

	/**
	 * Class Jardinier_Widget_Area.
	 */
	class Jardinier_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'jardinier_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'jardinier_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'jardinier_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function jardinier_widget_area() {
		return Jardinier_Widget_Area::get_instance();
	}

	jardinier_widget_area();
}
