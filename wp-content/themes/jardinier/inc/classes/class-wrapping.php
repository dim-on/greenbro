 ...
 */
add_filter( 'template_include', array( 'Jardinier_Wrapping', 'wrap' ), 99 );
add_filter( 'jardinier_wrap_base', 'jardinier_wrap_base_cpts' );
 ...
 */
function jardinier_template_path() {
	return Jardinier_Wrapping::$main_template;
}
 ...
 */
function jardinier_template_base() {
	return Jardinier_Wrapping::$base;
}

if ( ! class_exists( 'Jardinier_Wrapping' ) ) {
	...
	class Jardinier_Wrapping {
		...
		/**
		 * Initialize new instance of Jardinier_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'jardinier_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Jardinier_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function jardinier_wrap_base_cpts( $templates ) {
